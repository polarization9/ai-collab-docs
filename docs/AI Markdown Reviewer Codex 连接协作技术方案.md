# AI Markdown Reviewer Codex 连接协作技术方案
...
- 关联技术方案：`AI Markdown Reviewer Tauri 产品外壳技术方案.md`
- 目标版本：v0.4.0 起逐步落地
- 当前状态：技术方案草案，已纳入 App Server 来源会话续写验证结论

## 2. 设计边界

本技术方案对应 PRD 中的“产品外壳与 Codex 连接”模块，核心目标是让 AI Markdown Reviewer 成为 Markdown 文档和 Codex 会话之间的本地桥梁。
...
这意味着：AI Markdown Reviewer 只做“连接和投递”，上下文判断仍发生在 Codex 会话里。
...
```text
请把你当前这个 Codex 会话绑定为 AI Markdown Reviewer 的接续对话。

文档路径：
{{documentPath}}

请调用 AI Markdown Reviewer MCP：
reviewer_bind_current_codex_thread({
